...
[_QWERTY] = LAYOUT_ortho_4x12(
  ...
  _______, _______,        KC_LGUI, KC_LALT,    KC_LSFT,    CURSORLEFT,     CURSORRGHT,      KC_RSFT,    KC_RALT,        KC_APP,  _______, _______, \
...
[_EXTRARIGHT] = LAYOUT_ortho_4x12( \
  _______, KC_GRV,  PLOVER2,  PLOVER,  STENO_TXBOLT, STENO_TXBOLT2, KC_GRV,  KC_EQL,  KC_LPRN, KC_RPRN, KC_MINS, _______, \
...
[_PLOVER2] = LAYOUT_ortho_4x12( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_C,    KC_V,    KC_N,    KC_M,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  XXXXXXX, EXT_PLV, XXXXXXX, XXXXXXX, EXT_PLV, XXXXXXX, XXXXXXX, EXT_PLV, XXXXXXX, XXXXXXX, EXT_PLV, XXXXXXX \
),
...
[_STENO_TXBOLT] = LAYOUT_ortho_4x12( \
   ...
   XXXXXXX, EXT_PLV2,XXXXXXX, XXXXXXX, EXT_PLV2,XXXXXXX,    XXXXXXX, EXT_PLV2,XXXXXXX, XXXXXXX, EXT_PLV2, XXXXXXX \
 ), 
