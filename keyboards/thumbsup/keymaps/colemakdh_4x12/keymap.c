...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  LT(_EXTRARIGHT,KC_TAB),  KC_A,    KC_R,    KC_S,    KC_T,    KC_G,       KC_M,       KC_N,    KC_E,    KC_I,   KC_O, KC_ENT , \
  KC_LCTL,                 KC_X,    KC_C,    KC_D,    KC_V,    KC_Z,       KC_K,       KC_H,    KC_COMM, KC_DOT, KC_SLSH, KC_RCTL, \
...
[_NUMPAD] =  LAYOUT_ortho_4x12( \
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, KC_LALT, KC_RALT,  KC_1,    KC_2,    KC_3,    KC_PSLS, _______, \
                    _______, _______, _______, QWERTY,  QWERTY,   _______, KC_0,    KC_DOT	               \
),
